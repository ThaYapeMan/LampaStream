# HueSync — SoundSwitch Decomposition

**Status:** design/research baseline  
**Date:** 2026-09-13  
**Purpose:** decompose publicly observable SoundSwitch behavior into established DSP, MIR, musical-structure, and lighting-scheduler techniques that can guide HueSync.

---

## 1. Elon Musk approach for HueSync
...
### 1.3 Simplify and optimize only after the boundary is proven
...
### 1.4 Accelerate the feedback cycle
...
### 1.7 Evidence state per changeset
...
## 3. What SoundSwitch publicly and demonstrably does
...
## 4. Sufficient existing building blocks
...
## 6. Dynamics / energy: independent of spectrum
...
## 7. Onset / transient: a solved problem
...
## 8. Tempo, beat and phase: classical MIR is sufficient
...
## 9. Beatgrid and bar scheduler: probably a large part of the “intelligence”
...
## 10. Phrase / structure: Philips Research already did this
...
## 11. From abstract segments to SoundSwitch-like labels
...
## 12. Music State: SoundSwitch-like without a phrase detector
...
## 13. Lighting behavior: the scheduler is as important as the analyzer
...
## 14. Sufficient SoundSwitch-like architecture for HueSync
...
## 15. What we explicitly do **not** redesign
...
## 16. Licensing / implementation strategy
