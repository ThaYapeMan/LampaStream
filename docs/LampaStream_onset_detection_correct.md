...
# LampaStream — onset detection done correctly
...
LampaStream currently works on cava frames arriving at roughly 30 Hz. At that rate
...
It also decouples the project from slimproto entirely. LampaStream becomes "make
