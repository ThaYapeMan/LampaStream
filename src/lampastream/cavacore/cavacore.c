/*
 * Vendored from upstream karlstav/cava
 * Commit: 6d43df3b2c7882122585c02c064b20009842a6f8  (2026-08-18)
 * URL:    https://github.com/karlstav/cava/blob/6d43df3b/cavacore.c
 * License: MIT — Copyright (c) 2022 Karl Stavestrand <karl@stavestrand.no>
 *
 * Do not edit this file.  To upgrade cavacore, replace both cavacore.h and
 * cavacore.c with the new upstream versions and update the commit reference above.
 */
